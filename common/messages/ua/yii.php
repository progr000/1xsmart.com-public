<?php
return [
    '{attribute} must be equal to "{compareValueOrAttribute}".' => 'Значення повинно бути рівним "{compareValueOrAttribute}".',
    '{attribute} must be greater than "{compareValueOrAttribute}".' => 'Значення повинно бути більшим значення "{compareValueOrAttribute}".',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => 'Значення повинно бути більшим або дорівнювати значенню "{compareValueOrAttribute}".',
    '{attribute} must be less than "{compareValueOrAttribute}".' => 'Значення повинно бути меншим значення "{compareValueOrAttribute}".',
    '{attribute} must be less than or equal to "{compareValueOrAttribute}".' => 'Значення повинно бути меншим або дорівнювати значенню "{compareValueOrAttribute}".',
    '{attribute} must not be equal to "{compareValueOrAttribute}".' => 'Значення не повинно бути рівним "{compareValueOrAttribute}".',
    '(not set)' => '(не задано)',
    ...
    'The format of {attribute} is invalid.' => 'Невірний формат значення.',
    ...
    '{attribute} "{value}" has already been taken.' => 'Значення «{value}» вже зайнято.',
    '{attribute} cannot be blank.' => 'Обов`язкове поле',
    '{attribute} contains wrong subnet mask.' => 'Значення містить неправильну маску підмережі.',
    '{attribute} is invalid.' => 'Значення не вірне.',
    '{attribute} is not a valid URL.' => 'Значення не є правильним URL.',
    '{attribute} is not a valid email address.' => 'Значення не є правильною email адресою.',
    '{attribute} is not in the allowed range.' => 'Значення не входить в список дозволених діапазонів адрес.',
    '{attribute} must be "{requiredValue}".' => 'Значення має бути рівним "{requiredValue}".',
    '{attribute} must be a number.' => 'Значення має бути числом.',
    '{attribute} must be a string.' => 'Значення має бути текстовим рядком.',
    '{attribute} must be a valid IP address.' => 'Значення повинно бути правильною IP адресою.',
    '{attribute} must be an IP address with specified subnet.' => 'Значення повинно бути IP адресою з підмережею.',
    '{attribute} must be an integer.' => 'Значення має бути цілим числом.',
    '{attribute} must be either "{true}" or "{false}".' => 'Значення має дорівнювати "{true}" або "{false}".',
    '{attribute} must be no greater than {max}.' => 'Значення не повинно перевищувати {max}.',
    '{attribute} must be no less than {min}.' => 'Значення має бути більшим {min}.',
    '{attribute} must not be a subnet.' => 'Значення не повинно бути підмережею.',
    '{attribute} must not be an IPv4 address.' => 'Значення не повинно бути IPv4 адресою.',
    '{attribute} must not be an IPv6 address.' => 'Значення не повинно бути IPv6 адресою.',
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => 'Значення повинно містити мінімум {min, number} {min, plural, one{символ} few{символа} many{символів} other{символа}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => 'Значення повинно містити максимум {max, number} {max, plural, one{символ} few{символа} many{символів} other{символа}}.',
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => 'Значення повинно містити {length, number} {length, plural, one{символ} few{символа} many{символів} other{символа}}.',
