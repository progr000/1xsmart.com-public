...
return [
    ...
    'The format of {attribute} is invalid.' => 'Неверный формат.',
    ...
    'Unknown filter attribute "{attribute}"' => 'Неизвестный атрибут фильтра',
    ...
    '{attribute} "{value}" has already been taken.' => 'Значение «{value}» уже занято.',
    '{attribute} cannot be blank.' => 'Обязательное поле',
    '{attribute} contains wrong subnet mask.' => 'Значение содержит неверную маску подсети.',
    '{attribute} is invalid.' => 'Значение неверно.',
    '{attribute} is not a valid URL.' => 'Значение не является правильным URL.',
    '{attribute} is not a valid email address.' => 'Значение не является правильным email адресом.',
    '{attribute} is not in the allowed range.' => 'Значение не входит в список разрешенных диапазонов адресов.',
    '{attribute} must be "{requiredValue}".' => 'Значение должно быть равно «{requiredValue}».',
    '{attribute} must be a number.' => 'Значение должно быть числом.',
    '{attribute} must be a string.' => 'Значение должно быть строкой.',
    '{attribute} must be a valid IP address.' => 'Значение должно быть правильным IP адресом.',
    '{attribute} must be an IP address with specified subnet.' => 'Значение должно быть IP адресом с подсетью.',
    '{attribute} must be an integer.' => 'Значение должно быть целым числом.',
    '{attribute} must be either "{true}" or "{false}".' => 'Значение должно быть равно «{true}» или «{false}».',
    '{attribute} must be equal to "{compareValueOrAttribute}".' => 'Значение должно быть равно «{compareValueOrAttribute}».',
    '{attribute} must be greater than "{compareValueOrAttribute}".' => 'Значение должно быть больше значения «{compareValueOrAttribute}».',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => 'Значение должно быть больше или равно значения «{compareValueOrAttribute}».',
    '{attribute} must be less than "{compareValueOrAttribute}".' => 'Значение должно быть меньше значения «{compareValueOrAttribute}».',
    '{attribute} must be less than or equal to "{compareValueOrAttribute}".' => 'Значение должно быть меньше или равно значения «{compareValueOrAttribute}».',
    '{attribute} must be no greater than {max}.' => 'Значение не должно превышать {max}.',
    '{attribute} must be no less than {min}.' => 'Значение должно быть не меньше {min}.',
    '{attribute} must not be a subnet.' => 'Значение не должно быть подсетью.',
    ...
    '{attribute} must not be equal to "{compareValueOrAttribute}".' => 'Значение не должно быть равно «{compareValueOrAttribute}».',
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => 'Значение должно содержать минимум {min, number} {min, plural, one{символ} few{символа} many{символов} other{символа}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => 'Значение должно содержать максимум {max, number} {max, plural, one{символ} few{символа} many{символов} other{символа}}.',
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => 'Значение должно содержать {length, number} {length, plural, one{символ} few{символа} many{символов} other{символа}}.',
