...
class Users extends ActiveRecord implements IdentityInterface
{
    ...
    const STATUS_AFTER_INTRODUCE = 3;  // после вводного занятия с преподавателем
    const STATUS_AFTER_PAYMENT = 4;    // после того как юзер сделал оплату пакета уроков но еще не установил себе расписание
    ...
    /* поля не существуют в бд юзера, нужны для более простой обработки статуса урока, что бы не создавать отдельную модель формы */
...
//                    }
//
//                    /* Сбросим расписание ученика и установим ему статус STATUS_AFTER_PAYMENT */
//                    StudentsSchedule::deleteAll(['student_user_id' => $this->user_id]);
