...
class Mailq extends ActiveRecord
{
    ...
    {
        return [
            [['mail_from', 'mail_to', 'mail_subject', 'mail_body_html', 'mail_body_text', 'mailer_answer', 'mailer_letter_status'], 'required'],
            [['mail_created'], 'safe'],
            [['mail_from', 'mail_to', 'mail_reply_to', 'mail_subject', 'mail_body_html', 'mail_body_text', 'mailer_answer', 'mailer_description'], 'string'],
