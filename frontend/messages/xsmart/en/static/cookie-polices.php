...
return [
    'title' => "Cookie polices",

    'popup' => '<b>{APP_NAME} uses cookies:</b> technical, analytical, marketing and others. They are necessary for optimal operation of the site and services, help <b>{APP_NAME}</b> recognize you and store your settings. Read more in the <a href="' . Url::to(['/cookie-polices']) . '" data-off-target="_blank" class="cookie-layer__link">Cookie Policy</a>.',
    'text' => '
        <h1 class="page-title text-center">Cookie polices</h1>
        <div class="">

            <p><b>{APP_NAME}</b> ("us", "we", or "our") uses cookies on Pvtbox.net ("Website", or "Service"). By using the Service, you consent to the use of cookies</p>
