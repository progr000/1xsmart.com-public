...
return [
    ...
    'text' => '
        <h1 class="page-title text-center">Privacy polices</h1>
        <div class="">

            <p>{APP_NAME} ("us", "we", or "our") operates the Pvtbox.net ("Website", or "Service") and the desktop and  mobile application ("Application", or "Service")</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>"Data Controller"</strong> means the natural or legal person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal information are, or are to be, processed.
                    For the purpose of this Privacy Policy, we serve as Data Controller of your Personal Data.</p>
                </li>
                <li>
                    <p><strong>"Data Processor"</strong> or <strong>Service Provider</strong> means any natural or legal person who processes data on behalf of the Data Controller.
            ...
            <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is not limited to email address, phone number, cookies and usage data.</p>
            ...
            <h2>Use of Data</h2>
            <p>{APP_NAME} uses the collected data for various purposes, such as to:</p>
            <ul>
            ...
            <p>If you are from the European Economic Area (EEA), {APP_NAME} legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
            <p>{APP_NAME} may process your Personal Data because:</p>
            <ul>
            ...
            <p>{APP_NAME} will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy, and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Data Disclosure</h2>


            <p>{APP_NAME} may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
            ...
            <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. {APP_NAME} aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where {APP_NAME} relied on your consent to process your personal information.</p>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <p><strong>Apple Store In-App Payments</strong>
                ...
                <li>
                    <p><strong>Google Play In-App Payments</strong>
                ...
                <li>
                    <p><strong>PayPal / Braintree</strong>
            ...
            <ul>
                <li>By email: &nbsp; <a href="mailto:' . Yii::$app->params['supportEmail'] . '">' . Yii::$app->params['supportEmail'] . '</a></li>
