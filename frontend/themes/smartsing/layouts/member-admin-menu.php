...
<div class="user-menu-holder user-menu-holder--slide js-slide-user-menu <?= $hide_left_menu ? '_left' : '' ?>">
    ...
    <div class="user-menu-section">
        <div class="user-menu">
            <a class="user-menu__item js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($controller_id == 'admin' && $action_id == "index") ? '_current' : '' ?>"
               title="Главная"
               href="<?= Url::to(['admin/'], CREATE_ABSOLUTE_URL) ?>">
            ...
            <a class="user-menu__item user-menu__item--student js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($action_id == "students-list") ? '_current' : '' ?>"
               ...
               href="<?= Url::to(['admin/students-list'], CREATE_ABSOLUTE_URL) ?>">
            ...
            <a class="user-menu__item user-menu__item--coaches js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($action_id == "teachers-list") ? '_current' : '' ?>"
               ...
               href="<?= Url::to(['admin/teachers-list'], CREATE_ABSOLUTE_URL) ?>">
            ...
            <a class="user-menu__item user-menu__item--method js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($action_id == "methodists-list") ? '_current' : '' ?>"
               ...
               href="<?= Url::to(['admin/methodists-list'], CREATE_ABSOLUTE_URL) ?>">
                <span class="user-menu__item-span"><span>Список методистов</span></span>
            </a>
            <a class="user-menu__item user-menu__item--operator js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($action_id == "operators-list") ? '_current' : '' ?>"
               title="Список операторов"
               href="<?= Url::to(['admin/operators-list'], CREATE_ABSOLUTE_URL) ?>">
                <span class="user-menu__item-span"><span>Список операторов</span></span>
            </a>
            <a class="user-menu__item user-menu__item--partners js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?>"
               title="Список партнёров"
               href="javascript:;">
                <span class="user-menu__item-span"><span>Список партнёров</span></span>
            </a>
            <a class="user-menu__item user-menu__item--presets js-user-menu-item <?= $hide_left_menu ? '_hidden' : '' ?> <?= ($action_id == "presets") ? '_current' : '' ?>"
               title="Пресеты"
               href="<?= Url::to(['admin/presets'], CREATE_ABSOLUTE_URL) ?>">
