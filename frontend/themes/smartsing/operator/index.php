    ...
    <div class="dashboard dashboard--grid">
            ...
            <div class="dashboard__section-controls">
                <div class="totals">
                    <div class="total-number">
                        <div class="total-number__label">Показать за: </div>
                        &nbsp;&nbsp;
                        <div class="total-number__value <?= $modelRequestSearch->period_today ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                        ...
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= $modelRequestSearch->period_7 ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                        ...
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->period) ? '' : 'active' ?>">
                    ...
                    <div class="total-number">
                        <div class="total-number__label">Показать: </div>
                        &nbsp;&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->request_status == 'wait') ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                                'RequestSearch[request_status]' => 'wait'
                            ], CREATE_ABSOLUTE_URL) ?>"
                               data-pjax="1">wait</a>
                        </div>
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->request_status == 'work') ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                                'RequestSearch[request_status]' => 'work'
                            ], CREATE_ABSOLUTE_URL) ?>"
                               data-pjax="1">work</a>
                        </div>
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->request_status == null) ? 'active' : '' ?>">
                            <a href="<?= Url::to(['index'], CREATE_ABSOLUTE_URL) ?>"
                               data-pjax="1">все</a>
                        </div>
                    </div>
        ...
        ListView::widget([
            ...
            'layout' => '
                ...
                ',
            'emptyText' => '<div class="presets-empty">' . ($modelRequestSearch->period || $modelRequestSearch->operator_user_id ? 'По заданному поиску нет результатов' : 'Нет новых заявок от учеников' ) . '</div>',
            ...
            'itemView' => function ($model, $key, $index, $widget) use ($CurrentUser) {
                ...
                /**/
                if ($model->operator_user_id == $CurrentUser->user_id) {
                    $operator_user_full_name = 'Вы';
                } else {
                    $operator_user_full_name = 'Не назначен';
                }

                /**/
                if ($model->lead_in_work) {
                    $active_class = '';
                    $operator_block = '
                    ...
                    $operator_block = '
                        <div class="operator-actions">
                            ...
                            <a class="operator-actions__action-link"
                               data-pjax="0"
                               href="' . Url::to(['lead-start-processing', 'lead_id' => $model->lead_id]) . '">Взять в работу</a>
                        </div>
                    ';
                }
                    ...
                    <div class="lead-item leads-list__item ' . $active_class . '">
                        ...
                        <div class="lead-item__cell lead-controls">
                            <a class="bid-controls__btn bid-controls__btn--accept btn js-open-modal js-btn-add-new-student void-0"
                               ...
                               data-modal-id="new-student-modal">Создание ученика</a>
                        </div>
                    </div>
                    <!--.request-details-->
                ';
            ...
            <div class="dashboard__section-controls">
                <div class="totals">
                    <div class="total-number">
                        <div class="total-number__label">Показать за: </div>
                        &nbsp;&nbsp;
                        <div class="total-number__value <?= $modelIntroduceSearch->period_today ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                        ...
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= $modelIntroduceSearch->period_7 ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                        ...
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= ($modelIntroduceSearch->period) ? '' : 'active' ?>">
                            <a href="<?= Url::to(['index'], CREATE_ABSOLUTE_URL) ?>"
                               data-pjax="1">все</a>
                        </div>
                    </div>
                        ...
                        <div class="lead-item__cell">
                            <div class="user-block user-block--sm user-block--top">
                                <div class="user-block__ava">
                                    <img src="' . $model->getProfilePhotoForWeb('/assets/smartsing-min/images/no_photo.png') . '" alt="" />
                                </div>
                                <div class="user-block__data">
        ...
        ListView::widget([
            ...
            'layout' => '
                    ...
                    ',
            'emptyText' => '<div class="presets-empty">' . ($modelIntroduceSearch->period ? 'По заданному поиску нет результатов' : 'Нет прошедших вводных уроков' ) . '</div>',
            'emptyTextOptions' => ['tag' => false],
            'itemView' => function ($model, $key, $index, $widget) use ($CurrentUser) {
