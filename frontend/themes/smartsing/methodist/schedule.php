...
$this->title = Html::encode('Расписание занятий | Methodist area');

$next_lesson_text = "";
if (is_array($NextLesson)) {
    ...
    <div class="schedule-info schedule-info--lg dashboard__window dashboard__window dashboard__window--block win win win--grey">
        ...
        <div class="schedule-info__inner dashboard__window-inner">
            <picture class="schedule-info__media">
                <source srcset="/assets/smartsing-min/images/clock-2-w215.png" media="(max-width: 1400px)">
                <source srcset="/assets/smartsing-min/images/clock-2.png">
                <img srcset="/assets/smartsing-min/images/clock-2.png" alt="">
            </picture>
                ...
                <div class="schedule-info__current-info">
                    ...
                    <?php if ($NextLesson) { ?>
                        <span id="lesson-in-progress" style="<?= $NextLesson['timeline_timestamp'] <= time() ? '' : 'display: none;' ?>">
                            ...
                            Пожалуйста вернитесь в <a href="<?= $href ?>" target="_blank"><span class="highlight-c1">класс</span></a>, если вы из него вышли.
                        </span>
    ...
    <div class="notice-grid">
        <div class="notice-grid__item">
            <div class="notice-card">
                <div class="notice-card__icon-wrap"><svg class="svg-icon--refresh-color svg-icon" width="40" height="46">
        ...
        <div class="notice-grid__item">
            <div class="notice-card">
                <div class="notice-card__icon-wrap"><svg class="svg-icon--calendar-9 svg-icon" width="40" height="40">
                        <use xlink:href="#calendar-9"></use>
                    </svg></div>
                <div class="notice-card__text">
                    <div class="notice-card__title">Сообщите нам о своих планах <br>не менее чем за 10 часов</div>
                    <div class="notice-card__desc">Таким образом мы сможем скорректировать Ваш график наиболее эффективно, для проведения результативных вводных уроков.</div>
                </div>
            </div>
        </div>
    </div>
