...
<div class="present <?= ($CurrentUser->user_type == Users::TYPE_METHODIST && !$is_test_student) ? 'present--control' : '' ?>">
    ...
    <div class="present__info present-info-content-slides present__info--centered <?= ($CurrentUser->user_type == Users::TYPE_METHODIST && !$is_test_student) ? 'send-page' : '' ?>"
    ...
    <?php
    if ($CurrentUser->user_type == Users::TYPE_METHODIST && !$is_test_student) {
        ?>
...
if ($CurrentUser->user_type == Users::TYPE_METHODIST && !$is_test_student) {
    ...
    <div class="control-menu-holder">
        ...
        <div class="control-menu js-control-menu">
            ...
            <div class="control-menu__item control-menu__item_2"><a class="control-menu__link show-slide void-0" data-slide-num="2" href="#">Диапазон, координация</a></div>
            <div class="control-menu__item control-menu__item_3"><a class="control-menu__link show-slide void-0" data-slide-num="3" href="#">Диапазон результат</a></div>
            <div class="control-menu__item control-menu__item_4"><a class="control-menu__link show-slide void-0" data-slide-num="4" href="#">% координации голоса</a></div>
            <div class="control-menu__item control-menu__item_5"><a class="control-menu__link show-slide void-0" data-slide-num="5" href="#">Плотность и чистота голоса</a></div>
            <div class="control-menu__item control-menu__item_6"><a class="control-menu__link show-slide void-0" data-slide-num="6" href="#">Диаграмма уровня ученика</a></div>
            <div class="control-menu__item control-menu__item_7"><a class="control-menu__link show-slide void-0" data-slide-num="7" href="#">Курс предлагаем <br>(Базовый, Расширенный)</a></div>
            <div class="control-menu__item control-menu__item_8"><a class="control-menu__link show-slide void-0" data-slide-num="8" href="#">Что входит в обучение</a></div>
            <div class="control-menu__item control-menu__item_9"><a class="control-menu__link show-slide void-0" data-slide-num="9" href="#">Время обучения</a></div>
            <div class="control-menu__item control-menu__item_10"><a class="control-menu__link show-slide void-0" data-slide-num="10" href="#">Цена</a></div>
            <div class="control-menu__item control-menu__item_11"><a class="control-menu__link show-slide void-0" data-slide-num="11" href="#">Сравнение форматов обучения</a></div>
            <div class="control-menu__item control-menu__item_12" data-send-disabled="1"><a class="control-menu__link show-slide void-0" data-slide-num="12" href="#">Завершение урока и выставление параметров</a></div>
        </div>
    </div>
    <?php
}
