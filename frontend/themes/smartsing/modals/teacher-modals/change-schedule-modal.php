...
use frontend\assets\smartsing\teacher\ManageScheduleAsset;
...
<div class="modal" id="change-schedule-modal">
    <div class="modal__content scroll-wrapper js-scroll">
        <div class="modal__inner scroll-content">
            <p class="lg-text-size">Вы являетесь преподавателем школы <strong>Smart Sing</strong>, новые ученики
                приходят в школу регулярно, а следовательно они нуждаются в регулярных уроках.</p>
