...
use frontend\assets\smartsing\student\ManageScheduleOldAsset;

ManageScheduleOldAsset::register($this);
    ...
    <div class="step step--time win win--grey">
        ...
        <div class="step__inner">
            <div class="step__title">
                <div>Укажите в какое время вы хотите заниматься со своим учителем?</div>
            </div>
