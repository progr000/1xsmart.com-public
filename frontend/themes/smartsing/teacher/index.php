...
$this->title = Html::encode('Dashboard | Teacher area');
    ...
    <div class="dashboard__section">
        <div id="schedule-info-block"
            ...
            <div class="schedule-info__inner dashboard__window-inner">
                <div class="schedule-info__icon-wrap">
                    <svg class="svg-icon--calendar-8 svg-icon" width="69" height="60">
        ...
        <div class="class-entrance dashboard__window win win win--grey">
            ...
            <div class="class-entrance__inner dashboard__window-inner">
                <div class="class-entrance__title">
                    Регулярное занятие с учеником <?= isset($NextLesson['student_full_name']) ? $NextLesson['student_full_name'] : '' ?>
                </div>
                <div class="class-entrance__desc">
                    Учитель должен присутсвовать на уроке за <?= $left_minutes ?> <?= Functions::left_minutes_ru_text($left_minutes)[0] ?> до начала урока,
                    а также все время на протяжении урока (50 минут), даже если ученик отсуствует.
                </div>
...
<?= $this->render("../modals/teacher-modals/lesson-plan-modal") ?>
