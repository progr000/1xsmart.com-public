    ...
    <?php Pjax::begin([
        ...
        <div class="dashboard__section-title title">
            ...
            <div class="dashboard__section-controls">
                <div class="totals" style="display: grid;">
                    ...
                    <div class="total-number">
                        ...
                        &nbsp;&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->operator_user_id == 'null') ? 'active' : '' ?>">
                            <a href="<?= Url::to([
                                'index',
                                'RequestSearch[operator_user_id]' => 'null'
                            ], CREATE_ABSOLUTE_URL) ?>"
                               data-pjax="1">без оператора</a>
                        </div>
                        &nbsp;|&nbsp;
                        <div class="total-number__value <?= ($modelRequestSearch->operator_user_id == 'null') ? '' : 'active' ?>">
                            <a href="<?= Url::to(['index'], CREATE_ABSOLUTE_URL) ?>"
                    ...
                    $operator_block = '
                        <div class="user-block user-block--sm">
                            <div class="user-block__ava">
                                <img src="' . $Operator->getProfilePhotoForWeb('/assets/smartsing-min/images/no_photo.png') . '" alt="" />
                            </div>
