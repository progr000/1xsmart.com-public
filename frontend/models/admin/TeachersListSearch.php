 ...
 *
 */
class TeachersListSearch extends Users
{
    public $filter;
    public $sort;
     ...
     *
     * @param array $params
     * @param integer $teacher_profile_completed
     * @return ActiveDataProvider
     */
    public function search($params, $teacher_profile_completed)
    {
        $query = self::find()->alias('t1');

        $query->andWhere([
            't1.user_type'                 => self::TYPE_TEACHER,
            't1.teacher_profile_completed' => $teacher_profile_completed,
