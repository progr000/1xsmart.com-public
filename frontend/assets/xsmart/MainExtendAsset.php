...
class MainExtendAsset extends AssetBundle
{
     ...
     * и так же заменить пути для js и css (убрать из них часть пути themes/xsmart/)
    ...
    //public $sourcePath = '@frontend/web/themes/xsmart/';
    public $basePath = '@webroot';
    public $baseUrl = '@web';

    public $fullPathToSource       = '@frontend/web/';
    public $fullPathToMinimizedCss = '@frontend/web/assets/xsmart-min/css';
    public $webPathToMinimizedCss  = 'assets/xsmart-min/css/';
    public $fullPathToMinimizedJs  = '@frontend/web/assets/xsmart-min/js';
    public $webPathToMinimizedJs   = 'assets/xsmart-min/js/';
    public $pathToLinkMediaSources = '@frontend/web/assets/xsmart-min';
    public $mediaSourcesForLink = [
        '@frontend/web/themes/xsmart/files',
        '@frontend/web/themes/xsmart/fonts',
        '@frontend/web/themes/xsmart/icons',
        '@frontend/web/themes/xsmart/images',
        '@frontend/web/themes/xsmart/sounds',
        '@frontend/web/themes/xsmart/videos',
        '@frontend/web/themes/xsmart/icons',
    ];
