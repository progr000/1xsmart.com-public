...
class MainCssAsset extends MainExtendAsset
{
    ...
    public function init()
    {
        ...
        $this->css = [
            $this->compressFile("themes/smartsing/css/bundle.css", self::TYPE_CSS, null, true),
            $this->compressFile("themes/smartsing/css/bundle-repair.css", self::TYPE_CSS),
            $this->compressFile("themes/smartsing/css/bundle-repair-{$browser}.css", self::TYPE_CSS),
        ];
    }
}
