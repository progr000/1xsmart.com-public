...
class MainExtendAsset extends AssetBundle
{
     ...
     * и так же заменить пути для js и css (убрать из них часть пути themes/smartsing/)
    ...
    //public $sourcePath = '@frontend/web/themes/smartsing/';
    public $basePath = '@webroot';
    public $baseUrl = '@web';

    public $fullPathToSource       = '@frontend/web/';
    public $fullPathToMinimizedCss = '@frontend/web/assets/smartsing-min/css';
    public $webPathToMinimizedCss  = 'assets/smartsing-min/css/';
    public $fullPathToMinimizedJs  = '@frontend/web/assets/smartsing-min/js';
    public $webPathToMinimizedJs   = 'assets/smartsing-min/js/';
    public $pathToLinkMediaSources = '@frontend/web/assets/smartsing-min';
    public $mediaSourcesForLink = [
        '@frontend/web/themes/smartsing/files',
        '@frontend/web/themes/smartsing/fonts',
        '@frontend/web/themes/smartsing/icons',
        '@frontend/web/themes/smartsing/images',
        '@frontend/web/themes/smartsing/sounds',
        '@frontend/web/themes/smartsing/videos',
        '@frontend/web/themes/smartsing/icons',
    ];
